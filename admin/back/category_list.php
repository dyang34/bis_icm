...
?>
	<form name="pageForm" method="get"></form>
						...
						<!--카테고리(s)-->
						<div class="icm-float-wrap float-wrap">
							<!-- 카테고리 관리(s) -->
...
?>												
    												<a class="btn_inner" href="#" mode="INS" name="btnSubIns" imct_idx="<?=$arrCategory[$i]["imct_idx"]?>" depth="<?=$arrCategory[$i]["depth"]?>" title="" sort="<?=$arrCategory[$i]["sort"]?>" upper_imct_idx="<?=$arrCategory[$i]["upper_imct_idx"]?>" upper_title="<?=$arrCategory[$i]["upper_title"]?>" cate_title="<?=$arrCategory[$i]["title"]?>"><img src="/images/common/add_item.gif" /></a>
<?php
    }
?>
                                                    <a class="btn_inner" href="#" mode="UPD" name="btnUpd" imct_idx="<?=$arrCategory[$i]["imct_idx"]?>" depth="<?=$arrCategory[$i]["depth"]?>" title="" sort="<?=$arrCategory[$i]["sort"]?>" upper_imct_idx="<?=$arrCategory[$i]["upper_imct_idx"]?>" upper_title="<?=$arrCategory[$i]["upper_title"]?>" cate_title="<?=$arrCategory[$i]["title"]?>"><img src="/images/common/edit.png" /></a>
                                                    <a class="btn_inner" href="#" mode="UP" name="btnUp" imct_idx="<?=$arrCategory[$i]["imct_idx"]?>" depth="<?=$arrCategory[$i]["depth"]?>" title="" sort="<?=$arrCategory[$i]["sort"]?>"><img src="/images/common/up.png" /></a>
                                                    <a class="btn_inner" href="#" mode="DOWN" name="btnDown" imct_idx="<?=$arrCategory[$i]["imct_idx"]?>" depth="<?=$arrCategory[$i]["depth"]?>" title="" sort="<?=$arrCategory[$i]["sort"]?>"><img src="/images/common/down.png" /></a>
												</span>
<?php
/*
 if ($i < (count($arrCategory)-1) && ($arrCategory[$i+1]["depth"] > $arrCategory[$i]["depth"])) {
...
<?php
    if ($i < (count($arrCategory)-1) && ($arrCategory[$i+1]["depth"] > $arrCategory[$i]["depth"])) {
        $cnt_ul++;
?>
											<ul class="options items icm_dep<?=$arrCategory[$i]["depth"]?>">
<?php
