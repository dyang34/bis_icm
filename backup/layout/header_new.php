...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/resource/css/basic_new.css?v=<?=time()?>">
  ...
  <script type="text/javascript" src="/resource/js/script_new.js?v=<?=time()?>"></script>
...
<body>
  <div id="wrap">
	...
	<?php include $_SERVER['DOCUMENT_ROOT'].'/resource/layout/menu_new.php'; ?>
    <!--Left Menu area End */ -->
