...
if (LoginManager::getManagerLoginInfo("iam_grade") > 9) {
?>
                        <th>반영금액<span class="icm_layer"><img src="/images/common/que_1.png" alt="" style="margin-top: -2px; width: 9px; height: 9px;"/></span></th>
                        <th>공급합계</th>
                        <th>결제금액</th>
<?php     
}
...
<div class="icm_layerPop">
    ...
    <button type="button" class="absolutev absoluter" name="btn_talkingClose">
        <img src="/images/common/bl_list_1.png" alt="닫기" width="28" height="28">
        <span class="blind">화면닫기</span>
    </button>
</div>
<div class="icm_layerbg" name="btn_chargeClose"></div>			

<script type="text/javascript">

    var posY;

    $(document).on('click','.icm_layer',function(){
        posY = $(window).scrollTop();
        
        $('html,body').addClass('not-scroll');

            $('#wrap').css('top',-posY);
            $('.icm_layerPop').toggleClass('active');
            $('.icm_layerbg').addClass('active');
    ...
    $(document).on('click','div[name=btn_chargeClose],button[name=btn_talkingClose]',function(){
        ...
        $('.icm_layerbg,.icm_layerPop').removeClass('active');
